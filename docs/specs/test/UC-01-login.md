<!-- Status: Accepted | Version: 0.2 | Created: 2026-04-27 -->
# UC-01 · Test Spec — Login

**Status:** Accepted
**Owner:** Chris
**User Spec:** [`user/UC-01-login.md`](../../use-cases/UC-01-login.md)
**Functional Spec:** [`functional/UC-01-login.md`](../functional/UC-01-login.md)
...
- Penetration testing / brute-force timing attacks — out of scope per UC-01 scope boundaries.
